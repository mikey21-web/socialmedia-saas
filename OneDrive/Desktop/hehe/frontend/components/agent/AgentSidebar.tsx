    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            {/* Header */}
            <div className={`bg-gradient-to-r ${agentConfig.color} p-4 flex items-center justify-between flex-shrink-0`}>
            ...
            {/* Agent Selector */}
            <div className="flex gap-1.5 p-3 border-b border-border overflow-x-auto flex-shrink-0 bg-muted/30">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 && (
                <div className="flex flex-col items-center justify-center h-full text-center gap-4 py-8">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${agentConfig.color} flex items-center justify-center shadow-lg`}>
              ...
              {messages.map(msg => (
                <div key={msg.id} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  {msg.role === 'assistant' && (
                    <div className={`w-7 h-7 rounded-lg bg-gradient-to-br ${agentConfig.color} flex items-center justify-center flex-shrink-0 mt-0.5`}>
              ...
              {loading && !messages.some(m => m.streaming) && (
                <div className="flex gap-3 justify-start">
                  <div className={`w-7 h-7 rounded-lg bg-gradient-to-br ${agentConfig.color} flex items-center justify-center`}>
                    <Bot className="w-4 h-4 text-white" />
                  </div>
            ...
            <div className="p-3 border-t border-border flex-shrink-0 bg-background">
              <div className="flex gap-2 items-end">
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${agentConfig.color} flex items-center justify-center flex-shrink-0 shadow-sm transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed`}
                >
                  {loading ? (
