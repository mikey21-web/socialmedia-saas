...
import { z } from "zod";
import { Loader2, Plus, AlertCircle, Upload, X } from "lucide-react";
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={cn(
                  ...
                  charCount > 260 ? "text-destructive" : "text-muted-foreground"
                )}
              >
                {charCount}/280
              </span>
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Max 4 images/videos</p>
                </div>
              </div>
            </div>
            {media.length > 0 && (
